...
import application.multiAgent.agentHelper.LandlordCompare;
import application.multiAgent.behavior.listener.SelectListener;
import application.multiAgent.ontology.Bid;
import application.multiAgent.ontology.BidOntology;
import application.multiAgent.ontology.OrderResponse;
    ...
    public List<AID> createAgent(List<LandlordCompare> lists){
        ...
        try {
            for(LandlordCompare compare : lists) {
                ...
                AgentController agent = c.createNewAgent(name, "application.multiAgent.agent.LandlordAgent", new Object[]{land,count});

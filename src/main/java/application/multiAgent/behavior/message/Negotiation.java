...
//                }
                ...
                application.multiAgent.ontology.Negotiation negotiation;
                if(End){
                    negotiation = new application.multiAgent.ontology.Negotiation(Orderid,0, 0, 2,bid.getPrice());
                }else{
                    negotiation = new application.multiAgent.ontology.Negotiation(Orderid,minReduction, maxReduction, -1,bid.getPrice());
                }

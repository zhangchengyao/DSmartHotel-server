...
contract BidSystemFactory {
    ...
    */
    function createLandlord (uint _id, bytes32 _name, bytes32 _password, bytes32[] _otherInfo)
    public {
    ...
    function createTenant (uint _id, bytes32 _name, bytes32 _password, bytes32[] _otherInfo) public {
